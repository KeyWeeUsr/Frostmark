...
project = 'Frostmark'
copyright = '2018, Peter Badida'  # pylint: disable=redefined-builtin
author = 'Peter Badida'
...
htmlhelp_basename = 'Frostmarkdoc'
...
latex_documents = [(
    master_doc, 'Frostmark.tex', 'Frostmark Documentation',
    'Peter Badida', 'manual'
)]
...
man_pages = [(
    master_doc, 'frostmark', 'Frostmark Documentation',
    [author], 1
)]
...
texinfo_documents = [(
    master_doc, 'Frostmark', 'Frostmark Documentation',
    author, 'Frostmark', 'One line description of project.',
    'Miscellaneous'
)]

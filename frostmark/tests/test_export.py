...
class ExportTestCase(unittest.TestCase):
    ...
    def test_export_stdout(self):
        '''
        Test exporting HTML file from internal DB to STDOUT.
        '''
        ...
        # mock builtins.print() to capture STDOUT
    ...
    def test_export_prepare(self):
        '''
        Test preparint an export HTML file from internal DB.
        '''
        ...
        # compare results
        self.assertEqual(Exporter.prepare_export(), expected)
